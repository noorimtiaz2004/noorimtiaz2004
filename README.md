...
|:-----:|:-----|
| ~~blue_1~~ | *Can't move* |
| **blue_2** | [Token 2 — move 5 steps](https://github.com/noorimtiaz2004/noorimtiaz2004/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.&title=Ludo%3A+Move+blue_2) |
| **blue_3** | [Token 3 — move 5 steps](https://github.com/noorimtiaz2004/noorimtiaz2004/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.&title=Ludo%3A+Move+blue_3) |
| ~~blue_4~~ | *Can't move* |
<!-- END MOVES LIST -->
...
| Total moves | User |
|:-----------:|:-----|
| 44 | [@noorimtiaz2004](https://github.com/noorimtiaz2004) |
