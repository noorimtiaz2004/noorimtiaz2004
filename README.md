...
| Token | Move |
|:-----:|:-----|
| **green_1** | [Token 1 — move 4 steps](https://github.com/noorimtiaz2004/noorimtiaz2004/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.&title=Ludo%3A+Move+green_1) |
| **green_2** | [Token 2 — move 4 steps](https://github.com/noorimtiaz2004/noorimtiaz2004/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.&title=Ludo%3A+Move+green_2) |
| ~~green_3~~ | *Can't move* |
| ~~green_4~~ | *Can't move* |
<!-- END MOVES LIST -->
...
| Total moves | User |
|:-----------:|:-----|
| 32 | [@noorimtiaz2004](https://github.com/noorimtiaz2004) |
